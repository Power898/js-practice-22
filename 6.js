...
class AuthProcessor {setNextProcessor(processor) {
...
class TwoStepProcessor extends AuthProcessor{validate(username, passkey) {
  if (
    username === "john" &&
    passkey === "password" &&
...
class RoleProcessor extends AuthProcessor { validate(username, passkey) {
  if (username === "guest") {
...
class CredentialsProcessor extends AuthProcessor {validate(username, passkey) {
...
class ProcessorBuilder {constructor() {
