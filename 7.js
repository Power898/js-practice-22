...
class Participant {constructor(alias, communicator){ this.alias=alias; this.communicator= communicator;}
...
class SMSCommunicator {static transmit(message) {
...
class EmailCommunicator {static transmit(message) {
