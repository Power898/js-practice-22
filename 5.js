...
class Writer { #content= ""; set content(content){this.#content=content; this.#store();}
 get content() {return  this.#content;} 
 #store(){ Version.create(this.content);} restore(){ this.#content=Version.restore().content;}
...
class Version { constructor(content){this.content=content;} static #versions =[]; static create(content){ 
  this.#versions.push(new Version(content));} 
  static restore(){this.#versions.pop(); return this.#versions[this.#versions.length - 1] ;}
