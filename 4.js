...
class Drink { price=10; name="Чай"; prepare(){ console.log("Приготування {назва напою}");}

  // Метод prepare() виводить в консоль рядок "Приготування {назва напою}"
}

// Клас HoneyDecorator є декоратором, який додає мед до напою.
class HoneyDecorator { constructor(drink, amount){ this.drink=drink; this.amount=amount;}
get name() { return  `${this.drink.name} з ${this.amount} г меду`;} 
get price() { const honeyPrise = 0.5; return this.drink.price + this.amount * honeyPrise;} 
